...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        question_vec = question_to_vec(text_prepare(question), self.word_embeddings, self.embeddings_dim).reshape(1, -1)
        distances = pairwise_distances(question_vec, thread_embeddings)
        best_thread = distances.argmin(axis=1)[0]
